...
export interface ModelConfigEntry {
  ...
  /** 上游供应商实际成本 (积分/1M tokens) — 管理端保密 */
  inputCost?: number;
  /** 平台积分定价 (积分/1M tokens) — 用户端可见的价格 */
...
export const modelConfigEntries: ModelConfigEntry[] = [
  { id: 'MC-001', provider: 'OpenAI', name: 'GPT-4o', modelType: 'text', apiIdentifier: 'gpt-4o', asyncSupport: false, defaultTimeout: 30, defaultRetries: 3, status: 'active', capabilities: ['chat', 'function-calling', 'vision'], costPer1MTokens: 0.005, inputCost: 5, platformPrice: 15, contextWindow: 128000, description: 'OpenAI旗舰多模态模型' },
  { id: 'MC-002', provider: 'OpenAI', name: 'GPT-4 Turbo', modelType: 'text', apiIdentifier: 'gpt-4-turbo', asyncSupport: false, defaultTimeout: 30, defaultRetries: 3, status: 'active', capabilities: ['chat', 'function-calling', 'vision'], costPer1MTokens: 0.01, inputCost: 10, platformPrice: 30, contextWindow: 128000, description: '高性能文本模型' },
  { id: 'MC-003', provider: 'OpenAI', name: 'GPT-3.5 Turbo', modelType: 'text', apiIdentifier: 'gpt-3.5-turbo', asyncSupport: false, defaultTimeout: 20, defaultRetries: 2, status: 'active', capabilities: ['chat', 'function-calling'], costPer1MTokens: 0.0005, inputCost: 0.5, platformPrice: 1.5, contextWindow: 16000, description: '高性价比文本模型' },
  { id: 'MC-004', provider: 'Anthropic', name: 'Claude 3.5 Sonnet', modelType: 'text', apiIdentifier: 'claude-3-5-sonnet-20241022', asyncSupport: false, defaultTimeout: 45, defaultRetries: 3, status: 'active', capabilities: ['chat', 'function-calling', 'vision'], costPer1MTokens: 0.003, inputCost: 3, platformPrice: 9, contextWindow: 200000, description: 'Anthropic先进模型' },
  { id: 'MC-005', provider: 'Anthropic', name: 'Claude 3 Opus', modelType: 'text', apiIdentifier: 'claude-3-opus-20240229', asyncSupport: false, defaultTimeout: 60, defaultRetries: 3, status: 'active', capabilities: ['chat', 'function-calling', 'vision'], costPer1MTokens: 0.015, inputCost: 15, platformPrice: 45, contextWindow: 200000, description: 'Anthropic顶级模型' },
  { id: 'MC-006', provider: 'OpenAI', name: 'DALL-E 3', modelType: 'image', apiIdentifier: 'dall-e-3', asyncSupport: true, defaultTimeout: 60, defaultRetries: 2, status: 'active', capabilities: ['image-generation'], costPer1MTokens: 0.04, inputCost: 10, platformPrice: 40, contextWindow: 0, description: '高质量图片生成' },
  { id: 'MC-007', provider: 'Stability AI', name: 'Stable Diffusion 3', modelType: 'image', apiIdentifier: 'sd3', asyncSupport: true, defaultTimeout: 120, defaultRetries: 2, status: 'active', capabilities: ['image-generation'], costPer1MTokens: 0.025, inputCost: 6, platformPrice: 25, contextWindow: 0, description: '开源图片生成模型' },
  { id: 'MC-008', provider: 'Runway', name: 'Runway Gen-3', modelType: 'video', apiIdentifier: 'runway-gen3-alpha', asyncSupport: true, defaultTimeout: 300, defaultRetries: 2, status: 'active', capabilities: ['video-generation'], costPer1MTokens: 0.5, inputCost: 150, platformPrice: 500, contextWindow: 0, description: '高质量视频生成' },
  { id: 'MC-009', provider: 'Pika', name: 'Pika 1.5', modelType: 'video', apiIdentifier: 'pika-1.5', asyncSupport: true, defaultTimeout: 300, defaultRetries: 2, status: 'active', capabilities: ['video-generation'], costPer1MTokens: 0.45, inputCost: 120, platformPrice: 450, contextWindow: 0, description: '创意视频生成' },
  { id: 'MC-010', provider: 'OpenAI', name: 'Text Embedding 3', modelType: 'embedding', apiIdentifier: 'text-embedding-3-small', asyncSupport: false, defaultTimeout: 15, defaultRetries: 2, status: 'active', capabilities: ['embedding'], costPer1MTokens: 0.0001, inputCost: 0.05, platformPrice: 0.1, contextWindow: 8000, description: '文本向量化模型' },
  { id: 'MC-011', provider: 'OpenAI', name: 'Whisper v3', modelType: 'audio', apiIdentifier: 'whisper-1', asyncSupport: true, defaultTimeout: 120, defaultRetries: 2, status: 'inactive', capabilities: ['speech-to-text'], costPer1MTokens: 0.006, inputCost: 2, platformPrice: 6, contextWindow: 0, description: '语音转录模型' },
];

export const pricingRules: PricingRule[] = [
  { id: 'PR-001', name: 'GPT-4o标准定价', apiType: 'chat.completion', model: 'GPT-4o', modelId: 'MC-001', billingUnit: '1M tokens', creditCost: 15, tierRules: [{ threshold: 1000000, discount: 0.9 }, { threshold: 10000000, discount: 0.8 }], failRefund: true, effectiveTime: '2024-01-01', status: 'active' },
  { id: 'PR-002', name: 'GPT-4 Turbo标准定价', apiType: 'chat.completion', model: 'GPT-4 Turbo', modelId: 'MC-002', billingUnit: '1M tokens', creditCost: 30, tierRules: [{ threshold: 500000, discount: 0.85 }, { threshold: 5000000, discount: 0.75 }], failRefund: true, effectiveTime: '2024-01-01', status: 'active' },
  { id: 'PR-003', name: 'GPT-3.5 Turbo标准定价', apiType: 'chat.completion', model: 'GPT-3.5 Turbo', modelId: 'MC-003', billingUnit: '1M tokens', creditCost: 1.5, tierRules: [{ threshold: 5000000, discount: 0.9 }], failRefund: true, effectiveTime: '2024-01-01', status: 'active' },
  { id: 'PR-004', name: 'Claude 3.5 Sonnet标准定价', apiType: 'chat.completion', model: 'Claude 3.5 Sonnet', modelId: 'MC-004', billingUnit: '1M tokens', creditCost: 9, tierRules: [{ threshold: 1000000, discount: 0.9 }], failRefund: true, effectiveTime: '2024-02-01', status: 'active' },
  ...
  { id: 'PR-008', name: 'Embedding标准定价', apiType: 'embedding', model: 'Text Embedding 3', modelId: 'MC-010', billingUnit: '1M tokens', creditCost: 0.1, tierRules: [{ threshold: 10000000, discount: 0.8 }], failRefund: true, effectiveTime: '2024-01-01', status: 'active' },
