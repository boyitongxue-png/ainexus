...
async function seed() {
  ...
  // Seed Models
  const modelList = [
    { name: "GPT-4o", provider: "OpenAI", modelType: "text" as const, apiIdentifier: "gpt-4o", asyncSupport: false, defaultTimeout: 30, defaultRetries: 3, status: "active" as const, costPer1KTokens: "0.005", inputCost: "5", platformPrice: "15", contextWindow: 128000, description: "OpenAI 最新旗舰模型" },
    { name: "GPT-4", provider: "OpenAI", modelType: "text" as const, apiIdentifier: "gpt-4", asyncSupport: false, defaultTimeout: 30, defaultRetries: 3, status: "active" as const, costPer1KTokens: "0.03", inputCost: "10", platformPrice: "30", contextWindow: 128000, description: "高性能文本模型" },
    { name: "GPT-3.5 Turbo", provider: "OpenAI", modelType: "text" as const, apiIdentifier: "gpt-3.5-turbo", asyncSupport: false, defaultTimeout: 20, defaultRetries: 2, status: "active" as const, costPer1KTokens: "0.0005", inputCost: "0.5", platformPrice: "1.5", contextWindow: 16000, description: "高性价比文本模型" },
    { name: "Claude 3.5 Sonnet", provider: "Anthropic", modelType: "text" as const, apiIdentifier: "claude-3-5-sonnet", asyncSupport: false, defaultTimeout: 45, defaultRetries: 3, status: "active" as const, costPer1KTokens: "0.003", inputCost: "3", platformPrice: "9", contextWindow: 200000, description: "Anthropic 先进模型" },
    { name: "Claude 3 Opus", provider: "Anthropic", modelType: "text" as const, apiIdentifier: "claude-3-opus", asyncSupport: false, defaultTimeout: 60, defaultRetries: 3, status: "active" as const, costPer1KTokens: "0.015", inputCost: "15", platformPrice: "45", contextWindow: 200000, description: "Anthropic 顶级模型" },
    { name: "DALL-E 3", provider: "OpenAI", modelType: "image" as const, apiIdentifier: "dall-e-3", asyncSupport: true, defaultTimeout: 60, defaultRetries: 2, status: "active" as const, costPer1KTokens: "0.04", inputCost: "10", platformPrice: "40", contextWindow: 0, description: "高质量图片生成" },
    { name: "Stable Diffusion 3", provider: "Stability AI", modelType: "image" as const, apiIdentifier: "sd3", asyncSupport: true, defaultTimeout: 120, defaultRetries: 2, status: "active" as const, costPer1KTokens: "0.025", inputCost: "6", platformPrice: "25", contextWindow: 0, description: "开源图片生成模型" },
    { name: "Runway Gen-3", provider: "Runway", modelType: "video" as const, apiIdentifier: "runway-gen3", asyncSupport: true, defaultTimeout: 300, defaultRetries: 2, status: "beta" as const, costPer1KTokens: "0.5", inputCost: "150", platformPrice: "500", contextWindow: 0, description: "高质量视频生成" },
    { name: "Pika 1.5", provider: "Pika", modelType: "video" as const, apiIdentifier: "pika-1.5", asyncSupport: true, defaultTimeout: 300, defaultRetries: 2, status: "beta" as const, costPer1KTokens: "0.45", inputCost: "120", platformPrice: "450", contextWindow: 0, description: "创意视频生成" },
    { name: "Text Embedding 3", provider: "OpenAI", modelType: "embedding" as const, apiIdentifier: "text-embedding-3", asyncSupport: false, defaultTimeout: 15, defaultRetries: 2, status: "active" as const, costPer1KTokens: "0.0001", inputCost: "0.05", platformPrice: "0.1", contextWindow: 8000, description: "文本向量化模型" },
    { name: "Whisper v3", provider: "OpenAI", modelType: "audio" as const, apiIdentifier: "whisper-1", asyncSupport: true, defaultTimeout: 120, defaultRetries: 2, status: "active" as const, costPer1KTokens: "0.006", inputCost: "2", platformPrice: "6", contextWindow: 0, description: "语音转录模型" },
  ];
